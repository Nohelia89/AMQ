...
function AgregarAlojamiento() {
    ...
    const changeStateButton = (e) => {
     ...
     /*  aloj_direcion: {
        id: 0,
        calle: aloj.direccion.calle,
        numero: aloj.direccion.numero,
        ciudad: aloj.direccion.ciudad,
        pais: {
          id: 0,
          nombre: aloj.direccion.pais.nombre
        }
      },
...
const upload2 = async (e) =>{
  ...
  const Habitacion= ()=> {
    ...
    console.log ("SOY PAIS"+ pais+"SOY DATAFORM"+ dataForm.nombre + dataForm.descripcion +
    "SOY DIRECCION:"+ dir.calle +dir.numero + dir.ciudad)
    return (
